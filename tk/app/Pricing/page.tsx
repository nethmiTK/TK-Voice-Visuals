...
const pricingTiers = [
  ...
  },
  {
    ...
    features: ["Custom Web Application", "User Management", "Dashboard & Reports", "Database Integration", "Admin Panel"],
    priceCta: "Scale Now",
    featured: true,
  },
  {
...
const featureColumns = [
  { title: "Video", items: ["4K Production", "Editing", "Motion Graphics", "Scriptwriting"] },
  { title: "Voice", items: ["VO Recording", "Sound Design", "Podcast Setup", "Audio Strategy"] },
  { title: "Marketing", items: ["PPC Management", "Content Strategy", "SEO Optimization", "Analytics"] },
  { title: "Web", items: ["UI/UX Design", "Development", "Hosting", "Maintenance"] },
];

const faqItems = [
  {
    question: "How do you determine custom enterprise pricing?",
    answer: "Enterprise engagements are scoped based on output volume, platform complexity, and the level of strategic consulting required. We conduct a full audit before providing a detailed proposal.",
  },
  {
    question: "Can we mix and match services?",
    answer: "Yes. We can combine video, voice, marketing, and web into a tailored structure that fits your rollout schedule and brand goals.",
  },
  {
    question: "What is the typical turnaround time for Video?",
    answer: "Turnaround depends on the scope. Smaller social assets move quickly, while cinematic productions and larger campaigns are planned in phases.",
  },
];
    ...
    <main className={`${inter.className} bg-[#fff8f8] text-[#25181d] selection:bg-[#ffd9e4] selection:text-[#3e0022]`}>
      ...
      <section className="mx-auto max-w-7xl px-[5vw] pb-24 pt-40">
        <div className="max-w-4xl">
          ...
          <ScrollFillText
            as="h1"
            className="text-[clamp(3.5rem,8vw,5.5rem)] font-black leading-[0.92] tracking-[-0.05em]"
          ...
          <ScrollFillText
            as="p"
            className="max-w-2xl text-2xl font-light leading-relaxed"
            fillDirection="left"
            fillEnd={0.72}
          >
        ...
        {pricingTiers.map((tier) => (
          ...
          >
            <div className="mb-10">
              ...
              {/* On featured (pink) card, white text is fine. On white cards, apply fill. */}
              {tier.featured ? (
                <h2 className="text-4xl font-black tracking-[-0.04em] text-white">{tier.title}</h2>
              ) : (
                <ScrollFillText
                  as="h2"
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          ...
          <div className="rounded-[28px] border border-white/60 bg-white p-8 shadow-[0_20px_45px_rgba(177,14,107,0.05)] md:p-10 relative overflow-hidden flex flex-col">
            ...
            <div className="mt-10 pt-8 border-t border-[#f5dce3] relative z-10">
              ...
              <ul className="space-y-4">
                {[["Sinhala/Eng Subtitles", "1,000"], ["Custom Thumbnail", "1,500"], ["Motion Graphics", "2,500+"]].map(([label, price]) => (
          ...
          <div className="rounded-[28px] border border-white/60 bg-white p-8 shadow-[0_20px_45px_rgba(177,14,107,0.05)] md:p-10 relative overflow-hidden flex flex-col">
            ...
            <div className="mt-10 pt-8 border-t border-[#f5dce3] relative z-10">
              ...
              <ul className="space-y-4">
                {[["24-Hour Express", "+50%"], ["Extra Revisions", "1,000/rev"]].map(([label, price]) => (
                  <li key={label} className="flex items-baseline justify-between gap-2">
                    <span className="text-xs text-[#574048]">{label}</span>
      ...
      <section className="bg-white py-28 border-y border-[#f5dce3]">
        <div className="mx-auto max-w-7xl px-[5vw]">
          <div className="text-center mb-16">
            ...
            <ScrollFillText
              as="h2"
              className="font-serif text-[clamp(2.5rem,5vw,3.5rem)] leading-tight"
            ...
            <ScrollFillText
              as="p"
              className="text-lg max-w-2xl mx-auto leading-[1.8]"
              fillDirection="left"
              fillEnd={0.7}
            >
              Consistent, high-quality content designed for serious creators and growing brands looking to dominate their niche.
            </ScrollFillText>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { name: "Starter", price: "20,000", desc: "8 Reels (up to 30s), Basic Editing, Captions" },
              { name: "Growth", price: "40,000", desc: "16 Reels (up to 1 min), Advanced Editing, Custom Thumbnails", featured: true },
              { name: "Premium", price: "70,000", desc: "30 Reels (up to 1 min), Full Content Management, Priority Delivery" },
            ].map((pkg) => (
              <div key={pkg.name} className={`rounded-[24px] p-10 ${pkg.featured ? "bg-gradient-to-b from-[#b10e6b] to-[#a90b66] text-white shadow-2xl shadow-[#b10e6b]/30 scale-[1.02]" : "bg-[#fff8f8] text-[#25181d] border border-[#f5dce3]"}`}>
                {pkg.featured ? (
                  ...
                  <ScrollFillText as="h3" className="text-2xl font-bold" wrapperClassName="mb-3" fillDirection="left" fillEnd={0.68}>
                    {pkg.name}
                  </ScrollFillText>
                )}
      ...
      <section className="bg-[#fff0f3] py-24">
        <div className="mx-auto max-w-6xl px-[5vw]">
          <ScrollFillText
            as="h2"
            className="text-[clamp(2.25rem,5vw,3.5rem)] font-black tracking-[-0.05em]"
      ...
      <section className="bg-[#f5dce3] py-24">
        <div className="mx-auto max-w-3xl px-[5vw]">
          <ScrollFillText
            as="h2"
            className="text-center text-[clamp(2rem,4vw,2.75rem)] font-black"
      ...
      <section className="bg-white py-28 text-center">
        <div className="mx-auto max-w-3xl px-[5vw]">
          <ScrollFillText
            as="h2"
            className="text-[clamp(2.5rem,6vw,4.5rem)] font-black tracking-[-0.05em]"
            wrapperClassName="mb-6"
            fillDirection="top"
            fillEnd={0.8}
          >
          ...
          <ScrollFillText
            as="p"
            className="mx-auto max-w-xl text-xl leading-8"
            wrapperClassName="mt-6 mb-10"
            fillDirection="left"
            fillEnd={0.72}
          >
